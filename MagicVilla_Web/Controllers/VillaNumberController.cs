...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM villaNumberCreate)
        {
            ...
            {
                var response = await _villaNumberService.CreateAsync<APIResponse>(villaNumberCreate.VillaNumber );
                if (response != null && response.IsSuccess)
                {
            ...
            villaNumberCreate = new();
            var resp = await _villaService.GetAllAsync<APIResponse>();
            if (resp != null && resp.IsSuccess)
            {
                villaNumberCreate.VillaList = JsonConvert.DeserializeObject<List<VillaDTO>>(Convert.ToString(resp.Result))
                    .Select(u => new SelectListItem(text: u.Name, value: u.Id.ToString()));
            }
